...
#' function to check if object is of class BMADR and its subcalsses for internal use
#' @param x any R object
#' @return 1, 2 or 3 if object is of class BMABMDR using Laplace or BMABMDR using MCMC
#'
#' @examples
#'  x <- c(1, 5, 4)
#'  is.BMADR2(x)
