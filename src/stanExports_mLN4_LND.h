...
namespace model_mLN4_LND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mLN4_LND");
    reader.add_event(69, 67, "end", "model_mLN4_LND");
    return reader;
}
...
class model_mLN4_LND
  : public stan::model::model_base_crtp<model_mLN4_LND> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mLN4_LND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mLN4_LND_namespace::model_mLN4_LND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(c, ((1 + (stan::math::log((1 - q)) / a)) * (1 / (1 + stan::math::exp(-(get_base1(par, 3, "par", 1)))))));
            current_statement_begin__ = 41;
            stan::math::assign(d, stan::math::exp(get_base1(par, 4, "par", 1)));
            current_statement_begin__ = 42;
            stan::math::assign(b, stan::math::exp((inv_Phi((stan::math::log((1 - q)) / (a * (c - 1)))) - (get_base1(par, 2, "par", 1) * d))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mLN4_LND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mLN4_LND_namespace::model_mLN4_LND stan_model;
#ifndef USING_R
