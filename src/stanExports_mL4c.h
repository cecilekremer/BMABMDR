...
public:
  ...
  inline std::string model_name() const final { return "model_mL4c"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mL4c(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mL4c_namespace::model_mL4c";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mL4c_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if ((primitive_value(logical_eq(data_type, 1)) || primitive_value(
        ...
        if (logical_eq(data_type, 1)) {
          ...
          c = ((pow(3, 0.5) / stan::math::pi()) * logit((mu_0 / mu_inf)));
        } else {
          current_statement__ = 53;
          if (logical_eq(data_type, 2)) {
            current_statement__ = 51;
            c = ((pow(3, 0.5) / stan::math::pi()) *
                  logit(
        ...
        if ((primitive_value(logical_eq(data_type, 3)) || primitive_value(
          ...
          if (logical_eq(data_type, 3)) {
            ...
            c = ((pow(3, 0.5) / stan::math::pi()) * logit((mu_inf / mu_0)));
          } else {
      ...
      if (logical_eq(data_type, 1)) {
        ...
        b = (stan::math::exp((-k * d)) *
              (((pow(3, 0.5) / stan::math::pi()) *
                 logit(
                   (inv_logit(((stan::math::pi() / pow(3, 0.5)) * c)) *
                     (1 + q)))) - c));
      } else {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mL4c_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
