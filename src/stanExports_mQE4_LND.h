...
namespace model_mQE4_LND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4_LND");
    reader.add_event(68, 66, "end", "model_mQE4_LND");
    return reader;
}
...
class model_mQE4_LND
  : public stan::model::model_base_crtp<model_mQE4_LND> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mQE4_LND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mQE4_LND_namespace::model_mQE4_LND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, (-(stan::math::log((1 - (stan::math::log((1 - q)) / (a * (c - 1)))))) / (stan::math::exp(get_base1(par, 2, "par", 1)) + ((stan::math::exp(get_base1(par, 2, "par", 1)) * (stan::math::exp(get_base1(par, 2, "par", 1)) - 1)) / stan::math::exp(d)))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mQE4_LND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mQE4_LND_namespace::model_mQE4_LND stan_model;
#ifndef USING_R
