...
namespace model_mLN4_NI_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mLN4_NI");
    reader.add_event(68, 66, "end", "model_mLN4_NI");
    return reader;
}
...
class model_mLN4_NI
  : public stan::model::model_base_crtp<model_mLN4_NI> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mLN4_NI(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mLN4_NI_namespace::model_mLN4_NI";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(c, ((stan::math::exp(get_base1(par, 3, "par", 1)) + 1) + q));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mLN4_NI_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mLN4_NI_namespace::model_mLN4_NI stan_model;
#ifndef USING_R
