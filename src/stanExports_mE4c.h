...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mE4c");
    reader.add_event(212, 210, "end", "model_mE4c");
    return reader;
}
...
class model_mE4c
  : public stan::model::model_base_crtp<model_mE4c> {
private:
        int N;
        std::vector<int> n;
        int nc;
        ...
        try {
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::math::assign(mx, (a + ((a * (c - 1)) * (1 - stan::math::exp((-(b) * pow(get_base1(x, i, "x", 1), d)))))));
...
typedef model_mE4c_namespace::model_mE4c stan_model;
#ifndef USING_R
