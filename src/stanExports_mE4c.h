...
public:
  ~model_mE4c() {}
  model_mE4c(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mE4c_namespace::model_mE4c";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      if (stan::math::logical_eq(data_type, 1)) {
        ...
        if (stan::math::logical_eq(data_type, 2)) {
          ...
          b = (-stan::math::exp((-k * d)) *
            stan::math::log((1 - (stan::math::log((1 + q)) / (a * (c - 1))))));
        } else {
          ...
          if (stan::math::logical_eq(data_type, 3)) {
            ...
            if (stan::math::logical_eq(data_type, 4)) {
              ...
              b = (-stan::math::exp((-k * d)) *
                stan::math::log((1 - (stan::math::log((1 - q)) / (a * (c -
                  1))))));
            }
          }
        }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mE4c_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
