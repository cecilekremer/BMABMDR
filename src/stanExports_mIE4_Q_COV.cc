...
#include "stanExports_mIE4_Q_COV.h"

RCPP_MODULE(stan_fit4mIE4_Q_COV_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mIE4_Q_COV")
