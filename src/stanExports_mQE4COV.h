...
public:
  ...
  inline std::string model_name() const final { return "model_mQE4COV"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mQE4COV(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mQE4COV_namespace::model_mQE4COV";
    ...
    try {
      ...
      validate_non_negative_index("priormuQ", "nlevels", nlevels);
      current_statement__ = 211;
      context__.validate_dims("data initialization","priormuQ","double",
          context__.to_vec(5, nlevels));
      priormuQ = Eigen::Matrix<double, -1, -1>(5, nlevels);
      ...
      priorSigmaQ = Eigen::Matrix<double, -1, -1>(5, 5);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mQE4COV_namespace::log_prob";
(void) function__;  // suppress unused var warning
          ...
          if (logical_eq(data_type, 1)) {
            ...
            assign(b, cons_list(index_uni(1), nil_index_list()),
              (-stan::math::log((1 - (q / (c[(1 - 1)] - 1)))) /
                (stan::math::exp(k[(1 - 1)]) +
                  ((stan::math::exp(k[(1 - 1)]) *
                     (stan::math::exp(k[(1 - 1)]) - 1)) /
                    stan::math::exp(d[(1 - 1)])))), "assigning variable b");
          } else {
          ...
          if ((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) &&
            ...
            for (int mn = 1; mn <= nlevels_b; ++mn) {
              ...
              if (logical_eq(data_type, 1)) {
                ...
                assign(b, cons_list(index_uni(mn), nil_index_list()),
                  (-stan::math::log((1 - (q / (c[(1 - 1)] - 1)))) /
                    (stan::math::exp(k[(mn - 1)]) +
                      ((stan::math::exp(k[(mn - 1)]) *
                         (stan::math::exp(k[(mn - 1)]) - 1)) /
                        stan::math::exp(d[(mn - 1)])))),
                  "assigning variable b");
              } else {
            ...
            normal_lpdf<propto__>(par5[(i - 1)],
              rvalue(priormuQ,
                cons_list(index_uni(5),
                  cons_list(index_uni(i), nil_index_list())), "priormuQ"),
              rvalue(priorSigmaQ,
                cons_list(index_uni(5),
                  cons_list(index_uni(5), nil_index_list())), "priorSigmaQ")));
        }
        current_statement__ = 125;
        for (int i = 1; i <= nlevels_d; ++i) {
          current_statement__ = 122;
          if (logical_gt(par4[(i - 1)], truncdQ)) {
            current_statement__ = 122;
            lp_accum__.add(stan::math::negative_infinity());
          } else {
            current_statement__ = 122;
            lp_accum__.add(
              -normal_cdf_log(truncdQ,
                 rvalue(priormuQ,
          ...
          lp_accum__.add(
            normal_lpdf<propto__>(par4[(i - 1)],
              ...
              rvalue(priorSigmaQ,
                cons_list(index_uni(4),
                  cons_list(index_uni(4), nil_index_list())), "priorSigmaQ")));
        }
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mQE4COV_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
