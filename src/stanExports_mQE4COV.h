...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4COV");
    reader.add_event(304, 302, "end", "model_mQE4COV");
    return reader;
}
...
class model_mQE4COV
  : public stan::model::model_base_crtp<model_mQE4COV> {
private:
        int N;
        int nlevels;
        int nlevels_a;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("priormuQ", "5", 5);
            validate_non_negative_index("priormuQ", "nlevels", nlevels);
            context__.validate_dims("data initialization", "priormuQ", "matrix_d", context__.to_vec(5,nlevels));
            priormuQ = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(5, nlevels);
            vals_r__ = context__.vals_r("priormuQ");
            pos__ = 0;
            size_t priormuQ_j_2_max__ = nlevels;
            size_t priormuQ_j_1_max__ = 5;
            for (size_t j_2__ = 0; j_2__ < priormuQ_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < priormuQ_j_1_max__; ++j_1__) {
                    priormuQ(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("priorSigmaQ", "5", 5);
            validate_non_negative_index("priorSigmaQ", "5", 5);
            context__.validate_dims("data initialization", "priorSigmaQ", "matrix_d", context__.to_vec(5,5));
            priorSigmaQ = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(5, 5);
            vals_r__ = context__.vals_r("priorSigmaQ");
            pos__ = 0;
            size_t priorSigmaQ_j_2_max__ = 5;
            size_t priorSigmaQ_j_1_max__ = 5;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    ...
                                    (-(stan::math::log((1 - (q / (get_base1(c, 1, "c", 1) - 1))))) / (stan::math::exp(get_base1(k, 1, "k", 1)) + ((stan::math::exp(get_base1(k, 1, "k", 1)) * (stan::math::exp(get_base1(k, 1, "k", 1)) - 1)) / stan::math::exp(get_base1(d, 1, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 114;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)))))) / (stan::math::exp(get_base1(k, 1, "k", 1)) + ((stan::math::exp(get_base1(k, 1, "k", 1)) * (stan::math::exp(get_base1(k, 1, "k", 1)) - 1)) / stan::math::exp(get_base1(d, 1, "d", 1))))), 
                                    "assigning variable b");
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (q / (get_base1(c, mn, "c", 1) - 1))))) / (stan::math::exp(get_base1(k, 1, "k", 1)) + ((stan::math::exp(get_base1(k, 1, "k", 1)) * (stan::math::exp(get_base1(k, 1, "k", 1)) - 1)) / stan::math::exp(get_base1(d, 1, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 130;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)))))) / (stan::math::exp(get_base1(k, 1, "k", 1)) + ((stan::math::exp(get_base1(k, 1, "k", 1)) * (stan::math::exp(get_base1(k, 1, "k", 1)) - 1)) / stan::math::exp(get_base1(d, 1, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (q / (get_base1(c, 1, "c", 1) - 1))))) / (stan::math::exp(get_base1(k, mn, "k", 1)) + ((stan::math::exp(get_base1(k, mn, "k", 1)) * (stan::math::exp(get_base1(k, mn, "k", 1)) - 1)) / stan::math::exp(get_base1(d, mn, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 146;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)))))) / (stan::math::exp(get_base1(k, mn, "k", 1)) + ((stan::math::exp(get_base1(k, mn, "k", 1)) * (stan::math::exp(get_base1(k, mn, "k", 1)) - 1)) / stan::math::exp(get_base1(d, mn, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (q / (get_base1(c, mn, "c", 1) - 1))))) / (stan::math::exp(get_base1(k, mn, "k", 1)) + ((stan::math::exp(get_base1(k, mn, "k", 1)) * (stan::math::exp(get_base1(k, mn, "k", 1)) - 1)) / stan::math::exp(get_base1(d, mn, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 162;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)))))) / (stan::math::exp(get_base1(k, mn, "k", 1)) + ((stan::math::exp(get_base1(k, mn, "k", 1)) * (stan::math::exp(get_base1(k, mn, "k", 1)) - 1)) / stan::math::exp(get_base1(d, mn, "d", 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
            ...
            for (int i = 1; i <= nlevels_sigma; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(par5, i, "par5", 1), get_base1(priormuQ, 5, i, "priormuQ", 1), get_base1(priorSigmaQ, 5, 5, "priorSigmaQ", 1)));
            }
            current_statement_begin__ = 192;
            for (int i = 1; i <= nlevels_d; ++i) {
                current_statement_begin__ = 193;
                lp_accum__.add(normal_log<propto__>(get_base1(par4, i, "par4", 1), get_base1(priormuQ, 4, i, "priormuQ", 1), get_base1(priorSigmaQ, 4, 4, "priorSigmaQ", 1)));
                if (get_base1(par4, i, "par4", 1) > truncdQ) lp_accum__.add(-std::numeric_limits<double>::infinity());
                else lp_accum__.add(-normal_cdf_log(truncdQ, get_base1(priormuQ, 4, i, "priormuQ", 1), get_base1(priorSigmaQ, 4, 4, "priorSigmaQ", 1)));
            }
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else {
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            }
...
typedef model_mQE4COV_namespace::model_mQE4COV stan_model;
#ifndef USING_R
