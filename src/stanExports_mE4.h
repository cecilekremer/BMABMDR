...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mE4");
    reader.add_event(113, 111, "end", "model_mE4");
    return reader;
}
...
class model_mE4
  : public stan::model::model_base_crtp<model_mE4> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        double U;
public:
    model_mE4(stan::io::var_context& context__,
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(data_type, 1))) {
                ...
                stan::math::assign(b, (-(stan::math::exp((-(k) * d))) * stan::math::log((1 - (q / (c - 1))))));
            } else if (as_bool(logical_eq(data_type, 2))) {
                current_statement_begin__ = 82;
                stan::math::assign(b, (-(stan::math::exp((-(k) * d))) * stan::math::log((1 - (stan::math::log((1 + q)) / (a * (c - 1)))))));
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    lp_accum__.add((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(invsigma2))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * invsigma2)) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - a) - ((a * (c - 1)) * (1 - stan::math::exp((-(b) * pow(get_base1(x, i, "x", 1), d)))))))) * invsigma2)));
                }
            } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                current_statement_begin__ = 105;
                for (int i = 1; i <= N; ++i) {
                    current_statement_begin__ = 106;
                    lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(invsigma2))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * invsigma2)) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - a) - ((a * (c - 1)) * (1 - stan::math::exp((-(b) * pow(get_base1(x, i, "x", 1), d)))))))) * invsigma2)) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
...
typedef model_mE4_namespace::model_mE4 stan_model;
#ifndef USING_R
