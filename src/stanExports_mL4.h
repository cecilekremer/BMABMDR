...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mL4");
    reader.add_event(143, 141, "end", "model_mL4");
    return reader;
}
...
class model_mL4
  : public stan::model::model_base_crtp<model_mL4> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        double U;
public:
    model_mL4(stan::io::var_context& context__,
        ...
        try {
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 2))))) {
                ...
                if (as_bool(logical_eq(data_type, 1))) {
                    ...
                    stan::math::assign(a, stan::math::log(mu_inf));
                }
                ...
                if (as_bool(logical_eq(data_type, 3))) {
                    ...
                    stan::math::assign(a, stan::math::log(mu_0));
                }
            }
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 2))))) {
                ...
                if (as_bool(logical_eq(data_type, 1))) {
                    ...
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit((mu_0 / mu_inf))));
                } else if (as_bool(logical_eq(data_type, 2))) {
                    current_statement_begin__ = 81;
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit((stan::math::log(mu_0) / stan::math::log(mu_inf)))));
                }
            } else if (as_bool((primitive_value(logical_eq(data_type, 3)) || primitive_value(logical_eq(data_type, 4))))) {
                current_statement_begin__ = 84;
                if (as_bool(logical_eq(data_type, 3))) {
                    current_statement_begin__ = 85;
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit((mu_inf / mu_0))));
                } else if (as_bool(logical_eq(data_type, 4))) {
                    current_statement_begin__ = 87;
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit((stan::math::log(mu_inf) / stan::math::log(mu_0)))));
                }
            }
            ...
            if (as_bool(logical_eq(data_type, 1))) {
                ...
                stan::math::assign(b, (stan::math::exp((-(k) * d)) * (((pow(3, 0.5) / stan::math::pi()) * logit((inv_logit(((stan::math::pi() / pow(3, 0.5)) * c)) * (1 + q)))) - c)));
            } else if (as_bool(logical_eq(data_type, 2))) {
                current_statement_begin__ = 97;
                stan::math::assign(b, (stan::math::exp((-(k) * d)) * (((pow(3, 0.5) / stan::math::pi()) * logit((inv_logit(((stan::math::pi() / pow(3, 0.5)) * c)) + (stan::math::log((1 + q)) / a)))) - c)));
            } else if (as_bool(logical_eq(data_type, 3))) {
                current_statement_begin__ = 99;
                stan::math::assign(b, (stan::math::exp((-(k) * d)) * (((pow(3, 0.5) / stan::math::pi()) * logit((inv_logit(((stan::math::pi() / pow(3, 0.5)) * c)) + q))) - c)));
            } else if (as_bool(logical_eq(data_type, 4))) {
            ...
            if (as_bool(logical_eq(is_increasing, 1))) {
                ...
                if (as_bool(logical_eq(data_type, 1))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        lp_accum__.add((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(invsigma2))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * invsigma2)) - (((0.5 * get_base1(n, i, "n", 1)) * square((get_base1(m, i, "m", 1) - (a * inv_logit(((stan::math::pi() / pow(3, 0.5)) * (c + (b * pow(get_base1(x, i, "x", 1), d))))))))) * invsigma2)));
                    }
                } else if (as_bool(logical_eq(data_type, 2))) {
                ...
                if (as_bool(logical_eq(data_type, 3))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        lp_accum__.add((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(invsigma2))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * invsigma2)) - (((0.5 * get_base1(n, i, "n", 1)) * square((get_base1(m, i, "m", 1) - ((a * (1 + inv_logit(((stan::math::pi() / pow(3, 0.5)) * c)))) - (a * inv_logit(((stan::math::pi() / pow(3, 0.5)) * (c + (b * pow(get_base1(x, i, "x", 1), d)))))))))) * invsigma2)));
                    }
                } else if (as_bool(logical_eq(data_type, 4))) {
...
typedef model_mL4_namespace::model_mL4 stan_model;
#ifndef USING_R
