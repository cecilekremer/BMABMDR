...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(145, 143, "end", "model_mL4");
    return reader;
}
        ...
        try {
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 2))))) {
                ...
                if (as_bool(logical_eq(data_type, 1))) {
                    ...
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit(((stan::math::log(mu_0) - shift) / (stan::math::log(mu_inf) - shift)))));
                }
            } else if (as_bool((primitive_value(logical_eq(data_type, 3)) || primitive_value(logical_eq(data_type, 4))))) {
                ...
                if (as_bool(logical_eq(data_type, 3))) {
                    ...
                    stan::math::assign(c, ((pow(3, 0.5) / stan::math::pi()) * logit(((stan::math::log(mu_inf) - shift) / (stan::math::log(mu_0) - shift)))));
                }
            }
