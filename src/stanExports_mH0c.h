...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mH0c");
    reader.add_event(167, 165, "end", "model_mH0c");
    return reader;
}
...
class model_mH0c
  : public stan::model::model_base_crtp<model_mH0c> {
private:
        int N;
        std::vector<int> n;
        int nc;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("par", "3", 3);
            num_params_r__ += 3;
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("par", "3", 3);
        context__.validate_dims("parameter initialization", "par", "vector_d", context__.to_vec(3));
        Eigen::Matrix<double, Eigen::Dynamic, 1> par(3);
        size_t par_j_1_max__ = 3;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                par = in__.vector_constrain(3, lp__);
            else
                par = in__.vector_constrain(3);
            ...
            stan::math::assign(rho_cluster, get_base1(par, 3, "par", 1));
            ...
            lp_accum__.add(pert_dist_lpdf<propto__>(get_base1(par, 3, "par", 1), 0, 0.5, 1, 0.0001, pstream__));
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int j = 1; j <= nl; ++j) {
                        ...
                        stan::math::assign(m, rep_row_vector(a, lt));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> par = in__.vector_constrain(3);
        size_t par_j_1_max__ = 3;
        for (size_t j_1__ = 0; j_1__ < par_j_1_max__; ++j_1__) {
...
typedef model_mH0c_namespace::model_mH0c stan_model;
#ifndef USING_R
