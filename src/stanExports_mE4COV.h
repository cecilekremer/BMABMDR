...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mE4COV");
    reader.add_event(296, 294, "end", "model_mE4COV");
    return reader;
}
...
class model_mE4COV
  : public stan::model::model_base_crtp<model_mE4COV> {
private:
        int N;
        int nlevels;
        int nlevels_a;
            ...
            if (as_bool((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, 1, "k", 1)) * get_base1(d, 1, "d", 1)))) * stan::math::log((1 - (q / (get_base1(c, 1, "c", 1) - 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 114;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, 1, "k", 1)) * get_base1(d, 1, "d", 1)))) * stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)))))), 
                                    "assigning variable b");
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, 1, "k", 1)) * get_base1(d, 1, "d", 1)))) * stan::math::log((1 - (q / (get_base1(c, mn, "c", 1) - 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 130;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, 1, "k", 1)) * get_base1(d, 1, "d", 1)))) * stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, mn, "k", 1)) * get_base1(d, mn, "d", 1)))) * stan::math::log((1 - (q / (get_base1(c, 1, "c", 1) - 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 146;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, mn, "k", 1)) * get_base1(d, mn, "d", 1)))) * stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_eq(data_type, 1))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, mn, "k", 1)) * get_base1(d, mn, "d", 1)))) * stan::math::log((1 - (q / (get_base1(c, mn, "c", 1) - 1))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 2))) {
                        current_statement_begin__ = 161;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    (-(stan::math::exp((-(get_base1(k, mn, "k", 1)) * get_base1(d, mn, "d", 1)))) * stan::math::log((1 - (stan::math::log((1 + q)) / (get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)))))), 
                                    "assigning variable b");
                    } else if (as_bool(logical_eq(data_type, 3))) {
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, mn, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, mn, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, mn, "a", 1)) - ((get_base1(a, mn, "a", 1) * (get_base1(c, mn, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, mn, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))))))) * get_base1(invsigma2, mn, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else {
                ...
                if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add(((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, 1, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                } else if (as_bool((primitive_value(logical_eq(data_type, 2)) || primitive_value(logical_eq(data_type, 4))))) {
                    ...
                    for (int i = 1; i <= N; ++i) {
                        ...
                        for (int mn = 1; mn <= nlevels; ++mn) {
                            ...
                            lp_accum__.add((((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(get_base1(invsigma2, 1, "invsigma2", 1)))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * get_base1(invsigma2, 1, "invsigma2", 1))) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - get_base1(a, 1, "a", 1)) - ((get_base1(a, 1, "a", 1) * (get_base1(c, 1, "c", 1) - 1)) * (1 - stan::math::exp((-(get_base1(b, 1, "b", 1)) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))))))) * get_base1(invsigma2, 1, "invsigma2", 1))) - (get_base1(m, i, "m", 1) * get_base1(n, i, "n", 1))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            }
...
typedef model_mE4COV_namespace::model_mE4COV stan_model;
#ifndef USING_R
