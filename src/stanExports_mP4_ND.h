...
namespace model_mP4_ND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mP4_ND");
    reader.add_event(68, 66, "end", "model_mP4_ND");
    return reader;
}
...
class model_mP4_ND
  : public stan::model::model_base_crtp<model_mP4_ND> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mP4_ND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mP4_ND_namespace::model_mP4_ND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(c, (inv_Phi((1 - q)) - stan::math::exp(get_base1(par, 3, "par", 1))));
            current_statement_begin__ = 41;
            stan::math::assign(d, stan::math::exp(get_base1(par, 4, "par", 1)));
            current_statement_begin__ = 42;
            stan::math::assign(b, (stan::math::exp((-(get_base1(par, 2, "par", 1)) * d)) * (inv_Phi((Phi(c) + q)) - c)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mP4_ND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mP4_ND_namespace::model_mP4_ND stan_model;
#ifndef USING_R
