...
namespace model_mE4_ND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mE4_ND");
    reader.add_event(66, 64, "end", "model_mE4_ND");
    return reader;
}
...
class model_mE4_ND
  : public stan::model::model_base_crtp<model_mE4_ND> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mE4_ND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mE4_ND_namespace::model_mE4_ND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, (-(stan::math::exp((-(get_base1(par, 2, "par", 1)) * d))) * stan::math::log((1 + (q / (c - 1))))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mE4_ND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mE4_ND_namespace::model_mE4_ND stan_model;
#ifndef USING_R
