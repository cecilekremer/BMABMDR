...
public:
  ...
  inline std::string model_name() const final { return "model_mH4COV"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mH4COV_namespace::log_prob";
(void) function__;  // suppress unused var warning
          ...
          if (logical_eq(data_type, 1)) {
            ...
            assign(b, cons_list(index_uni(1), nil_index_list()),
              (stan::math::exp((k[(1 - 1)] * d[(1 - 1)])) *
                (((c[(1 - 1)] - 1) / q) - 1)), "assigning variable b");
          } else {
          ...
          for (int mn = 1; mn <= nlevels_b; ++mn) {
            ...
            if (logical_eq(data_type, 1)) {
              ...
              assign(b, cons_list(index_uni(mn), nil_index_list()),
                (stan::math::exp((k[(1 - 1)] * d[(1 - 1)])) *
                  (((c[(mn - 1)] - 1) / q) - 1)), "assigning variable b");
            } else {
