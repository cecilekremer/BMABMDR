...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 13, column 2 to column 50)",
                                                      " (in 'string', line 26, column 2 to column 31)",
                                                      " (in 'string', line 18, column 11 to column 12)",
                                                      " (in 'string', line 18, column 4 to column 38)",
                                                      " (in 'string', line 19, column 4 to column 20)",
                                                      ...
                                                      " (in 'string', line 5, column 2 to column 11)",
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lprior\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"b_Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
