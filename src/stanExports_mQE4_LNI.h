...
namespace model_mQE4_LNI_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4_LNI");
    reader.add_event(68, 66, "end", "model_mQE4_LNI");
    return reader;
}
...
class model_mQE4_LNI
  : public stan::model::model_base_crtp<model_mQE4_LNI> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mQE4_LNI(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mQE4_LNI_namespace::model_mQE4_LNI";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mQE4_LNI_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mQE4_LNI_namespace::model_mQE4_LNI stan_model;
#ifndef USING_R
