...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mLN4_Q_COV");
    reader.add_event(155, 153, "end", "model_mLN4_Q_COV");
    return reader;
}
...
class model_mLN4_Q_COV
  : public stan::model::model_base_crtp<model_mLN4_Q_COV> {
private:
        int N;
        int nlevels;
        int nlevels_a;
        ...
        try {
            ...
            if (as_bool((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::model::assign(b, 
                                stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                stan::math::exp((inv_Phi(q) - (get_base1(k, 1, "k", 1) * get_base1(d, 1, "d", 1)))), 
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::model::assign(b, 
                                stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                stan::math::exp((inv_Phi(q) - (get_base1(k, mn, "k", 1) * get_base1(d, mn, "d", 1)))), 
                                "assigning variable b");
                }
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * Phi((stan::math::log(get_base1(b, mn, "b", 1)) + (get_base1(d, mn, "d", 1) * stan::math::log(get_base1(x, i, "x", 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * Phi((stan::math::log(get_base1(b, mn, "b", 1)) + (get_base1(d, mn, "d", 1) * stan::math::log(get_base1(x, i, "x", 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * Phi((stan::math::log(get_base1(b, 1, "b", 1)) + (get_base1(d, 1, "d", 1) * stan::math::log(get_base1(x, i, "x", 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * Phi((stan::math::log(get_base1(b, 1, "b", 1)) + (get_base1(d, 1, "d", 1) * stan::math::log(get_base1(x, i, "x", 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_gt(nlevels_d, 1)))) && primitive_value(logical_gt(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * Phi((stan::math::log(get_base1(b, mn, "b", 1)) + (get_base1(d, mn, "d", 1) * stan::math::log(get_base1(x, i, "x", 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * Phi((stan::math::log(get_base1(b, mn, "b", 1)) + (get_base1(d, mn, "d", 1) * stan::math::log(get_base1(x, i, "x", 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * Phi((stan::math::log(get_base1(b, 1, "b", 1)) + (get_base1(d, 1, "d", 1) * stan::math::log(get_base1(x, i, "x", 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * Phi((stan::math::log(get_base1(b, 1, "b", 1)) + (get_base1(d, 1, "d", 1) * stan::math::log(get_base1(x, i, "x", 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            }
...
typedef model_mLN4_Q_COV_namespace::model_mLN4_Q_COV stan_model;
#ifndef USING_R
