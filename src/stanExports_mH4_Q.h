...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mH4_Q");
    reader.add_event(105, 103, "end", "model_mH4_Q");
    return reader;
}
...
class model_mH4_Q
  : public stan::model::model_base_crtp<model_mH4_Q> {
private:
        int N;
        vector_d n;
        vector_d x;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, (stan::math::exp((k * d)) * ((1 / q) - 1)));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                    ...
                    stan::model::assign(m, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (a + ((1 - a) * (1 - (b / (b + pow(get_base1(x, i, "x", 1), d)))))), 
                                "assigning variable m");
                }
            }
            ...
            if (as_bool(logical_eq(is_betabin, 1))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::model::assign(abet, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (get_base1(m, i, "m", 1) * ((1 / get_base1(rho, 1, "rho", 1)) - 1)), 
                                "assigning variable abet");
                    current_statement_begin__ = 74;
                    stan::model::assign(bbet, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((1.0 - get_base1(m, i, "m", 1)) * ((1 / get_base1(rho, 1, "rho", 1)) - 1)), 
...
typedef model_mH4_Q_namespace::model_mH4_Q stan_model;
#ifndef USING_R
