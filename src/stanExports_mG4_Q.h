...
public:
  ~model_mG4_Q() {}
  model_mG4_Q(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mG4_Q_namespace::model_mG4_Q";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mG4_Q_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      stan::model::assign(theta, BMD, "assigning variable theta",
        stan::model::index_uni(1));
      ...
      stan::model::assign(yG,
        stan::math::algebra_solver(algebra_system_functor__(), y_guess,
          ...
          1e3), "assigning variable yG");
      current_statement__ = 24;
      b = stan::model::rvalue(yG, "yG", stan::model::index_uni(1));
      ...
      if (stan::math::logical_eq(is_bin, 0)) {
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          stan::model::assign(abet,
            (stan::model::rvalue(m, "m", stan::model::index_uni(i)) * ((1.0 /
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mG4_Q_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"a", "d", "b", "k", "theta", "y_guess", "yG", "m", "abet",
             "bbet", "BMD"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"par1\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"par2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"par3\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(is_betabin) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"d\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"k\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"y_guess\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"yG\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"m\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"abet\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"bbet\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"BMD\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]");
  }
