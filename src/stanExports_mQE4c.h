...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4c");
    reader.add_event(218, 216, "end", "model_mQE4c");
    return reader;
}
...
class model_mQE4c
  : public stan::model::model_base_crtp<model_mQE4c> {
private:
        int N;
        std::vector<int> n;
        int nc;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("priormuQ", "6", 6);
            context__.validate_dims("data initialization", "priormuQ", "vector_d", context__.to_vec(6));
            priormuQ = Eigen::Matrix<double, Eigen::Dynamic, 1>(6);
            vals_r__ = context__.vals_r("priormuQ");
            pos__ = 0;
            size_t priormuQ_j_1_max__ = 6;
        ...
        try {
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::math::assign(mx, (a + ((a * (c - 1)) * (1 - stan::math::exp(((-(b) * get_base1(x, i, "x", 1)) - (((b / stan::math::exp(d)) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))));
...
typedef model_mQE4c_namespace::model_mQE4c stan_model;
#ifndef USING_R
