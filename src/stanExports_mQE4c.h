...
public:
  ...
  inline std::string model_name() const final { return "model_mQE4c"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mQE4c(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mQE4c_namespace::model_mQE4c";
    ...
    try {
      ...
      context__.validate_dims("data initialization","priormuQ","double",
          context__.to_vec(6));
      priormuQ = Eigen::Matrix<double, -1, 1>(6);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mQE4c_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      invsigma2 = stan::math::exp(par5);
      {
        ...
        if (logical_gt(par4, truncdQ)) {
          current_statement__ = 57;
          lp_accum__.add(stan::math::negative_infinity());
        } else {
          current_statement__ = 57;
          lp_accum__.add(
            -normal_cdf_log(truncdQ, priormuQ[(4 - 1)],
               rvalue(priorSigmaQ,
        ...
        lp_accum__.add(
          normal_lpdf<propto__>(par4, priormuQ[(4 - 1)],
            rvalue(priorSigmaQ,
              cons_list(index_uni(4),
                cons_list(index_uni(4), nil_index_list())), "priorSigmaQ")));
        current_statement__ = 59;
        lp_accum__.add(
          normal_lpdf<propto__>(par5, priormuQ[(5 - 1)],
            rvalue(priorSigmaQ,
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mQE4c_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
