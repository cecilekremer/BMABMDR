...
public:
  ...
  inline std::string model_name() const final { return "model_mH0"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mH0_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      par = Eigen::Matrix<local_scalar_t__, -1, 1>(2);
          ...
          for (int i = 1; i <= N; ++i) {
            ...
            lp_accum__.add(
              (((((-0.5 * n[(i - 1)]) *
                ...
                (((0.5 * n[(i - 1)]) * square((m[(i - 1)] - a))) * invsigma2)));
          }
        } else {
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"par\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"invsigma2\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
