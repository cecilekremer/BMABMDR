...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mP4_Q");
    reader.add_event(110, 108, "end", "model_mP4_Q");
    return reader;
}
...
class model_mP4_Q
  : public stan::model::model_base_crtp<model_mP4_Q> {
private:
        int N;
        vector_d n;
        vector_d x;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(expr, ((q * (1 - a)) + a));
            current_statement_begin__ = 59;
            if (as_bool(logical_lt(expr, 1.0))) {
                current_statement_begin__ = 60;
                stan::math::assign(b, ((inv_Phi(((q * (1 - a)) + a)) - inv_Phi(a)) / stan::math::exp((k * d))));
            } else {
                current_statement_begin__ = 62;
                stan::math::assign(b, ((inv_Phi(0.9999) - inv_Phi(a)) / stan::math::exp((k * d))));
            }
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                    ...
                    stan::model::assign(m, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                Phi((inv_Phi(a) + (b * pow(get_base1(x, i, "x", 1), d)))), 
                                "assigning variable m");
                }
            }
            ...
            if (as_bool(logical_eq(is_betabin, 1))) {
                ...
                stan::model::assign(rho, 
                            ...
                            ((stan::math::exp(get_base1(etarho, is_betabin, "etarho", 1)) - 1) / (stan::math::exp(get_base1(etarho, is_betabin, "etarho", 1)) + 1)), 
...
typedef model_mP4_Q_namespace::model_mP4_Q stan_model;
#ifndef USING_R
