...
public:
  ~model_mL4COV() {}
  model_mL4COV(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mL4COV_namespace::model_mL4COV";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mL4COV_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      for (int mn = 1; mn <= nlevels_a; ++mn) {
        ...
        if ((stan::math::primitive_value(stan::math::logical_eq(data_type, 1))
          ...
          if (stan::math::logical_eq(data_type, 1)) {
            ...
            stan::model::assign(c, ((stan::math::pow(3, 0.5) /
              stan::math::pi()) *
              stan::math::logit(
                (stan::model::rvalue(mu_0, "mu_0", stan::model::index_uni(mn))
                /
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mL4COV_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
