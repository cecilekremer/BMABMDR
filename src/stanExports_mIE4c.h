...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mIE4c");
    reader.add_event(222, 220, "end", "model_mIE4c");
    return reader;
}
...
class model_mIE4c
  : public stan::model::model_base_crtp<model_mIE4c> {
private:
        int N;
        std::vector<int> n;
        int nc;
            ...
            if (as_bool((primitive_value(logical_eq(data_type, 1)) || primitive_value(logical_eq(data_type, 3))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                        ...
                        stan::math::assign(mx, (a + ((a * (c - 1)) * stan::math::exp((-(b) * pow(get_base1(x, i, "x", 1), -(d)))))));
                    }
...
typedef model_mIE4c_namespace::model_mIE4c stan_model;
#ifndef USING_R
