...
namespace model_mSM_ND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mSM_ND");
    reader.add_event(25, 23, "end", "model_mSM_ND");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mSM_ND
  : public stan::model::model_base_crtp<model_mSM_ND> {
private:
        int N;
        vector_d n;
        vector_d m;
        ...
        matrix_d priorSigma;
public:
    model_mSM_ND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mSM_ND_namespace::model_mSM_ND";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mSM_ND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mSM_ND_namespace::model_mSM_ND stan_model;
#ifndef USING_R
