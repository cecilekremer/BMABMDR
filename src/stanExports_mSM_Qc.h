...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 34, column 2 to line 35, column 41)",
                                                      " (in 'string', line 53, column 2 to column 57)",
                                                      " (in 'string', line 40, column 11 to column 12)",
                                                      " (in 'string', line 40, column 4 to column 38)",
                                                      " (in 'string', line 41, column 4 to column 29)",
                                                      " (in 'string', line 44, column 6 to column 40)",
                                                      " (in 'string', line 42, column 19 to line 45, column 5)",
                                                      ...
                                                      " (in 'string', line 30, column 9 to column 12)"};
#include <stan_meta_header.hpp>
class model_mSM_Qc final : public model_base_crtp<model_mSM_Qc> {
private:
  int N;
  std::vector<int> Y;
...
public:
  ...
  inline std::string model_name() const final { return "model_mSM_Qc"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mSM_Qc_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" << Kc << "},\"block\":\"parameters\"},{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" << M_1 << "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" << M_1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_1 << "}},\"block\":\"parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"lprior\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"b_Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_mSM_Qc_namespace::model_mSM_Qc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mSM_Qc_namespace::profiles__;
}
#endif
#endif
