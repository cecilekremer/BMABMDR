...
namespace model_mQE4_ND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4_ND");
    reader.add_event(70, 68, "end", "model_mQE4_ND");
    return reader;
}
...
class model_mQE4_ND
  : public stan::model::model_base_crtp<model_mQE4_ND> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mQE4_ND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mQE4_ND_namespace::model_mQE4_ND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, (-(stan::math::log((1 - (-(q) / (c - 1))))) / (stan::math::exp(get_base1(par, 2, "par", 1)) + ((stan::math::exp(get_base1(par, 2, "par", 1)) * (stan::math::exp(get_base1(par, 2, "par", 1)) - 1)) / stan::math::exp(d)))));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add((((((-(0.5) * get_base1(n, i, "n", 1)) * stan::math::log((2 * stan::math::pi()))) + ((0.5 * get_base1(n, i, "n", 1)) * stan::math::log(invsigma2))) - (((0.5 * (get_base1(n, i, "n", 1) - 1)) * get_base1(s2, i, "s2", 1)) * invsigma2)) - (((0.5 * get_base1(n, i, "n", 1)) * square(((get_base1(m, i, "m", 1) - a) - ((a * (c - 1)) * (1 - stan::math::exp((((-(b) * get_base1(x, i, "x", 1)) - ((b * square(get_base1(x, i, "x", 1))) / stan::math::exp(d))) + ((b * get_base1(x, i, "x", 1)) / stan::math::exp(d))))))))) * invsigma2)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mQE4_ND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mQE4_ND_namespace::model_mQE4_ND stan_model;
#ifndef USING_R
