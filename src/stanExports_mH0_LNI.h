...
namespace model_mH0_LNI_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mH0_LNI");
    reader.add_event(25, 23, "end", "model_mH0_LNI");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mH0_LNI
  : public stan::model::model_base_crtp<model_mH0_LNI> {
private:
        int N;
        vector_d n;
        vector_d m;
        ...
        matrix_d priorSigma;
public:
    model_mH0_LNI(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mH0_LNI_namespace::model_mH0_LNI";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mH0_LNI_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mH0_LNI_namespace::model_mH0_LNI stan_model;
#ifndef USING_R
