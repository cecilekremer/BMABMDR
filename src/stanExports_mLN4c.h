...
public:
  ~model_mLN4c() {}
  model_mLN4c(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mLN4c_namespace::model_mLN4c";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mLN4c_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      if (stan::math::logical_eq(data_type, 1)) {
        ...
        b = stan::math::exp((stan::math::inv_Phi((q / (c - 1))) - (k * d)));
      } else {
        current_statement__ = 49;
        if (stan::math::logical_eq(data_type, 2)) {
          current_statement__ = 47;
          b = stan::math::exp(
                (stan::math::inv_Phi((stan::math::log((1 + q)) / (a * (c -
                   1)))) - (k * d)));
        } else {
          current_statement__ = 46;
          if (stan::math::logical_eq(data_type, 3)) {
            current_statement__ = 44;
            b = stan::math::exp((stan::math::inv_Phi((-q / (c - 1))) - (k *
                  d)));
          } else {
        ...
        if ((stan::math::primitive_value(stan::math::logical_eq(data_type, 1))
          ...
          for (int i = 1; i <= N; ++i) {
            ...
            if (stan::math::logical_eq(
              ...
              mx = (a + ((a * (c - 1)) *
                stan::math::Phi((stan::math::log(b) + (d *
                  stan::math::log(
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mLN4c_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
