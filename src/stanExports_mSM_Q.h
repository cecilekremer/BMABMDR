...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'mSM_Q', line 32, column 2 to column 20)",
                                                      " (in 'mSM_Q', line 33, column 2 to column 41)",
                                                      " (in 'mSM_Q', line 36, column 2 to column 18)",
                                                      " (in 'mSM_Q', line 37, column 2 to column 15)",
                                                      " (in 'mSM_Q', line 38, column 2 to column 15)",
                                                      " (in 'mSM_Q', line 40, column 2 to column 16)",
                                                      " (in 'mSM_Q', line 42, column 6 to column 29)",
                                                      " (in 'mSM_Q', line 44, column 8 to column 22)",
                                                      " (in 'mSM_Q', line 43, column 19 to line 45, column 7)",
                                                      " (in 'mSM_Q', line 43, column 6 to line 45, column 7)",
                                                      " (in 'mSM_Q', line 47, column 8 to column 22)",
                                                      " (in 'mSM_Q', line 46, column 19 to line 48, column 7)",
                                                      " (in 'mSM_Q', line 46, column 6 to line 48, column 7)",
                                                      " (in 'mSM_Q', line 41, column 19 to line 49, column 3)",
                                                      " (in 'mSM_Q', line 41, column 2 to line 49, column 3)",
                                                      " (in 'mSM_Q', line 57, column 6 to column 20)",
                                                      " (in 'mSM_Q', line 58, column 6 to column 20)",
                                                      " (in 'mSM_Q', line 56, column 17 to line 59, column 5)",
                                                      " (in 'mSM_Q', line 56, column 4 to line 59, column 5)",
                                                      " (in 'mSM_Q', line 55, column 9 to line 60, column 3)",
                                                      " (in 'mSM_Q', line 52, column 6 to column 54)",
                                                      " (in 'mSM_Q', line 53, column 6 to column 62)",
                                                      " (in 'mSM_Q', line 51, column 17 to line 54, column 5)",
                                                      " (in 'mSM_Q', line 51, column 4 to line 54, column 5)",
                                                      " (in 'mSM_Q', line 50, column 18 to line 55, column 3)",
                                                      " (in 'mSM_Q', line 50, column 2 to line 60, column 3)",
                                                      " (in 'mSM_Q', line 63, column 2 to column 62)",
                                                      " (in 'mSM_Q', line 65, column 6 to column 30)",
                                                      " (in 'mSM_Q', line 64, column 2 to line 65, column 30)",
                                                      " (in 'mSM_Q', line 71, column 6 to column 61)",
                                                      " (in 'mSM_Q', line 73, column 13 to line 75, column 46)",
                                                      " (in 'mSM_Q', line 72, column 20 to line 76, column 7)",
                                                      " (in 'mSM_Q', line 72, column 6 to line 76, column 7)",
                                                      " (in 'mSM_Q', line 70, column 12 to line 77, column 5)",
                                                      " (in 'mSM_Q', line 68, column 7 to column 92)",
                                                      " (in 'mSM_Q', line 67, column 20 to line 69, column 6)",
                                                      " (in 'mSM_Q', line 67, column 6 to line 69, column 6)",
                                                      " (in 'mSM_Q', line 66, column 18 to line 70, column 6)",
                                                      " (in 'mSM_Q', line 66, column 4 to line 77, column 5)",
                                                      " (in 'mSM_Q', line 19, column 2 to column 8)",
                                                      " (in 'mSM_Q', line 20, column 2 to column 12)",
                                                      " (in 'mSM_Q', line 21, column 9 to column 10)",
                                                      " (in 'mSM_Q', line 21, column 2 to column 14)",
                                                      " (in 'mSM_Q', line 22, column 9 to column 10)",
                                                      " (in 'mSM_Q', line 22, column 2 to column 14)",
                                                      " (in 'mSM_Q', line 23, column 2 to column 18)",
                                                      " (in 'mSM_Q', line 24, column 2 to column 15)",
                                                      " (in 'mSM_Q', line 25, column 2 to column 24)",
                                                      " (in 'mSM_Q', line 26, column 2 to column 17)",
                                                      " (in 'mSM_Q', line 27, column 2 to column 11)",
                                                      " (in 'mSM_Q', line 28, column 2 to column 31)",
                                                      " (in 'mSM_Q', line 29, column 2 to column 35)",
                                                      " (in 'mSM_Q', line 32, column 9 to column 14)",
                                                      " (in 'mSM_Q', line 33, column 29 to column 39)",
                                                      " (in 'mSM_Q', line 36, column 9 to column 14)",
                                                      " (in 'mSM_Q', line 37, column 12 to column 13)",
                                                      " (in 'mSM_Q', line 38, column 12 to column 13)",
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      par = Eigen::Matrix<local_scalar_t__, -1, 1>(Ndose);
      stan::math::fill(par, DUMMY_VAR__);
      
      current_statement__ = 1;
      par = in__.vector(Ndose);
      ...
      a = Eigen::Matrix<local_scalar_t__, -1, 1>(Ndose);
      ...
      assign(a, cons_list(index_uni(1), nil_index_list()), par[(1 - 1)],
        "assigning variable a");
      current_statement__ = 15;
      for (int k = 2; k <= Ndose; ++k) {
        current_statement__ = 7;
        assign(a, cons_list(index_uni(k), nil_index_list()),
          (a[((k - 1) - 1)] + par[(k - 1)]), "assigning variable a");
        current_statement__ = 10;
        if (logical_lte(a[(k - 1)], 0)) {
          current_statement__ = 8;
          assign(a, cons_list(index_uni(k), nil_index_list()), 0.0001,
            "assigning variable a");
        } 
        current_statement__ = 13;
        if (logical_gte(a[(k - 1)], 1)) {
          current_statement__ = 11;
          assign(a, cons_list(index_uni(k), nil_index_list()), 0.9999,
            "assigning variable a");
        } }
      ...
      if (logical_eq(is_bin, 0)) {
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          assign(abet, cons_list(index_uni(i), nil_index_list()),
            ((y[(i - 1)] / n[(i - 1)]) * ((1 / rho[(is_betabin - 1)]) - 1.0)),
            "assigning variable abet");
          current_statement__ = 22;
          assign(bbet, cons_list(index_uni(i), nil_index_list()),
            ((1.0 - (y[(i - 1)] / n[(i - 1)])) *
              ((1.0 / rho[(is_betabin - 1)]) - 1)), "assigning variable bbet");
        }
      } else {
      ...
      }
      {
        ...
        lp_accum__.add(
          pert_dist_lpdf<propto__>(par[(1 - 1)], priorlb, priormu[(1 - 1)],
            priorub, priorgama, pstream__));
        current_statement__ = 29;
        for (int k = 2; k <= Ndose; ++k) {
          current_statement__ = 28;
          lp_accum__.add(uniform_lpdf<propto__>(par[(k - 1)], -1, 1));}
          ...
          for (int i = 1; i <= N; ++i) {
            ...
            lp_accum__.add(
              ((binomial_coefficient_log(n[(i - 1)], y[(i - 1)]) +
                 (y[(i - 1)] * stan::math::log((a[(i - 1)] + eps)))) +
                ((n[(i - 1)] - y[(i - 1)]) *
                  stan::math::log(((1 - a[(i - 1)]) + eps)))));}
        } else {
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      par = Eigen::Matrix<double, -1, 1>(Ndose);
      ...
      a = Eigen::Matrix<double, -1, 1>(Ndose);
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      rho_free__ = std::vector<double>(is_betabin, std::numeric_limits<double>::quiet_NaN());
  ...
  inline void get_dims(std::vector<std::vector<size_t>>& dimss__) const {
    dimss__.clear();
    dimss__.emplace_back(std::vector<size_t>{static_cast<size_t>(Ndose)});
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"par\",\"type\":{\"name\":\"vector\",\"length\":" << Ndose << "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" << is_betabin << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"vector\",\"length\":" << Ndose << "},\"block\":\"transformed_parameters\"},{\"name\":\"abet\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"bbet\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
