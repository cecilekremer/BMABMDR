...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mLN4_Q");
    reader.add_event(103, 101, "end", "model_mLN4_Q");
    return reader;
}
...
class model_mLN4_Q
  : public stan::model::model_base_crtp<model_mLN4_Q> {
private:
        int N;
        vector_d n;
        vector_d x;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, stan::math::exp((inv_Phi(q) - (k * d))));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                    ...
                    stan::model::assign(m, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (a + ((1 - a) * Phi((stan::math::log(b) + (d * stan::math::log(get_base1(x, i, "x", 1))))))), 
                                "assigning variable m");
                }
            }
            ...
            if (as_bool(logical_eq(is_betabin, 1))) {
                ...
                stan::model::assign(rho, 
                            ...
                            ((stan::math::exp(get_base1(etarho, 1, "etarho", 1)) - 1.0) / (stan::math::exp(get_base1(etarho, 1, "etarho", 1)) + 1.0)), 
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::model::assign(abet, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (get_base1(m, i, "m", 1) * ((1.0 / get_base1(rho, 1, "rho", 1)) - 1.0)), 
                                "assigning variable abet");
                    current_statement_begin__ = 72;
                    stan::model::assign(bbet, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((1.0 - get_base1(m, i, "m", 1)) * ((1.0 / get_base1(rho, 1, "rho", 1)) - 1.0)), 
...
typedef model_mLN4_Q_namespace::model_mLN4_Q stan_model;
#ifndef USING_R
