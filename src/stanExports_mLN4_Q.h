...
public:
  ~model_mLN4_Q() {}
  model_mLN4_Q(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mLN4_Q_namespace::model_mLN4_Q";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mLN4_Q_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      b = stan::math::exp((stan::math::inv_Phi(q) - (k * d)));
      ...
      if (stan::math::logical_eq(is_bin, 0)) {
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          stan::model::assign(abet,
            ...
            1.0)), "assigning variable abet", stan::model::index_uni(i));
          current_statement__ = 32;
          stan::model::assign(bbet, ((1.0 -
            stan::model::rvalue(m, "m", stan::model::index_uni(i))) * ((1.0 /
            stan::model::rvalue(rho, "rho", stan::model::index_uni(1))) -
            1.0)), "assigning variable bbet", stan::model::index_uni(i));
        }
      } else {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mLN4_Q_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
