...
algebra_system(const T0__& yG_arg__, const T1__& theta_arg__,
  ...
  const auto& yG = stan::math::to_ref(yG_arg__);
  ...
  try {
    ...
    if (stan::math::logical_gt(
          stan::model::rvalue(yG, "yG", stan::model::index_uni(1)), 0)) {
      current_statement__ = 160;
      stan::model::assign(x,
        (stan::math::gamma_p(
           stan::model::rvalue(theta, "theta", stan::model::index_uni(2)),
           (stan::model::rvalue(yG, "yG", stan::model::index_uni(1)) *
           stan::model::rvalue(theta, "theta", stan::model::index_uni(1)))) -
        q), "assigning variable x", stan::model::index_uni(1));
    } else {
...
public:
  ~model_mG4_Q_COV() {}
  model_mG4_Q_COV(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mG4_Q_COV_namespace::model_mG4_Q_COV";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      stan::math::validate_non_negative_index("yG", "1", 1);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mG4_Q_COV_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      if ((stan::math::primitive_value(
        ...
        for (int mn = 1; mn <= nlevels_b; ++mn) {
          ...
          stan::model::assign(theta,
            stan::model::rvalue(BMD, "BMD", stan::model::index_uni(1)),
        ...
        if ((stan::math::primitive_value(
          ...
          if ((stan::math::primitive_value(
            ...
            for (int mn = 1; mn <= nlevels_b; ++mn) {
              ...
              stan::model::assign(theta,
                stan::model::rvalue(BMD, "BMD", stan::model::index_uni(mn)),
                "assigning variable theta", stan::model::index_uni(1));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mG4_Q_COV_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"a", "b", "d", "k", "BMD", "theta", "y_guess", "yG"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_transformed_parameters__) {
      ...
      for (int sym1__ = 1; sym1__ <= 1; ++sym1__) {
        param_names__.emplace_back(std::string() + "yG" + '.' +
          std::to_string(sym1__));
      }
    }
    if (emit_generated_quantities__) {}
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_transformed = emit_transformed_parameters *
      ((((((((nlevels_a + nlevels_b) + nlevels_d) + nlevels_BMD) +
      nlevels_BMD) + 2) + 1) + 1));
