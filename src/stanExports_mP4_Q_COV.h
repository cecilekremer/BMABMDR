...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mP4_Q_COV");
    reader.add_event(175, 173, "end", "model_mP4_Q_COV");
    return reader;
}
...
class model_mP4_Q_COV
  : public stan::model::model_base_crtp<model_mP4_Q_COV> {
private:
        int N;
        int nlevels;
        int nlevels_a;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            (void) expr;  // dummy to suppress unused var warning
            stan::math::initialize(expr, DUMMY_VAR__);
            stan::math::fill(expr, DUMMY_VAR__);
            ...
            if (as_bool((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::math::assign(expr, ((q * (1 - get_base1(a, 1, "a", 1))) + get_base1(a, 1, "a", 1)));
                    current_statement_begin__ = 70;
                    if (as_bool(logical_lt(expr, 1.0))) {
                        current_statement_begin__ = 71;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(((q * (1 - get_base1(a, 1, "a", 1))) + get_base1(a, 1, "a", 1))) - inv_Phi(get_base1(a, 1, "a", 1))) / stan::math::exp((get_base1(k, 1, "k", 1) * get_base1(d, 1, "d", 1)))), 
                                    "assigning variable b");
                    } else {
                        current_statement_begin__ = 73;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(0.9999) - inv_Phi(get_base1(a, 1, "a", 1))) / stan::math::exp((get_base1(k, 1, "k", 1) * get_base1(d, 1, "d", 1)))), 
                                    "assigning variable b");
                    }
                }
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::math::assign(expr, ((q * (1 - get_base1(a, mn, "a", 1))) + get_base1(a, mn, "a", 1)));
                    current_statement_begin__ = 79;
                    if (as_bool(logical_lt(expr, 1.0))) {
                        current_statement_begin__ = 80;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(((q * (1 - get_base1(a, mn, "a", 1))) + get_base1(a, mn, "a", 1))) - inv_Phi(get_base1(a, mn, "a", 1))) / stan::math::exp((get_base1(k, 1, "k", 1) * get_base1(d, 1, "d", 1)))), 
                                    "assigning variable b");
                    } else {
                        current_statement_begin__ = 82;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(0.9999) - inv_Phi(get_base1(a, mn, "a", 1))) / stan::math::exp((get_base1(k, 1, "k", 1) * get_base1(d, 1, "d", 1)))), 
                                    "assigning variable b");
                    }
                }
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_lt(expr, 1.0))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(((q * (1 - get_base1(a, 1, "a", 1))) + get_base1(a, 1, "a", 1))) - inv_Phi(get_base1(a, 1, "a", 1))) / stan::math::exp((get_base1(k, mn, "k", 1) * get_base1(d, mn, "d", 1)))), 
                                    "assigning variable b");
                    } else {
                        current_statement_begin__ = 91;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(0.9999) - inv_Phi(get_base1(a, 1, "a", 1))) / stan::math::exp((get_base1(k, mn, "k", 1) * get_base1(d, mn, "d", 1)))), 
                                    "assigning variable b");
                    }
                }
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    if (as_bool(logical_lt(expr, 1.0))) {
                        ...
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(((q * (1 - get_base1(a, mn, "a", 1))) + get_base1(a, mn, "a", 1))) - inv_Phi(get_base1(a, mn, "a", 1))) / stan::math::exp((get_base1(k, mn, "k", 1) * get_base1(d, mn, "d", 1)))), 
                                    "assigning variable b");
                    } else {
                        current_statement_begin__ = 100;
                        stan::model::assign(b, 
                                    stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                    ((inv_Phi(0.9999) - inv_Phi(get_base1(a, mn, "a", 1))) / stan::math::exp((get_base1(k, mn, "k", 1) * get_base1(d, mn, "d", 1)))), 
                                    "assigning variable b");
                    }
                }
            }
            ...
            current_statement_begin__ = 52;
            if (stan::math::is_uninitialized(expr)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: expr";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable expr: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            // model body
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log((Phi((inv_Phi(get_base1(a, 1, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - Phi((inv_Phi(get_base1(a, 1, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1)))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log((Phi((inv_Phi(get_base1(a, mn, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - Phi((inv_Phi(get_base1(a, mn, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1)))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_gt(nlevels_d, 1)))) && primitive_value(logical_gt(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log((Phi((inv_Phi(get_base1(a, mn, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - Phi((inv_Phi(get_base1(a, mn, "a", 1)) + (get_base1(b, mn, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, mn, "d", 1)))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log((Phi((inv_Phi(get_base1(a, 1, "a", 1)) + (get_base1(b, 1, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - Phi((inv_Phi(get_base1(a, 1, "a", 1)) + (get_base1(b, 1, "b", 1) * pow(get_base1(x, i, "x", 1), get_base1(d, 1, "d", 1)))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            }
...
typedef model_mP4_Q_COV_namespace::model_mP4_Q_COV stan_model;
#ifndef USING_R
