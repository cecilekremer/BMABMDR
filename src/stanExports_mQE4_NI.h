...
namespace model_mQE4_NI_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4_NI");
    reader.add_event(71, 69, "end", "model_mQE4_NI");
    return reader;
}
...
class model_mQE4_NI
  : public stan::model::model_base_crtp<model_mQE4_NI> {
private:
        int N;
        vector_d n;
        vector_d x;
        ...
        matrix_d priorSigma;
public:
    model_mQE4_NI(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mQE4_NI_namespace::model_mQE4_NI";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mQE4_NI_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mQE4_NI_namespace::model_mQE4_NI stan_model;
#ifndef USING_R
