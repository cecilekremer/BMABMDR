...
namespace model_mSM_LND_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mSM_LND");
    reader.add_event(25, 23, "end", "model_mSM_LND");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mSM_LND
  : public stan::model::model_base_crtp<model_mSM_LND> {
private:
        int N;
        vector_d n;
        vector_d m;
        ...
        matrix_d priorSigma;
public:
    model_mSM_LND(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mSM_LND_namespace::model_mSM_LND";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(a, stan::model::rvalue(par, stan::model::cons_list(stan::model::index_min_max(1, N), stan::model::nil_index_list()), "par"));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mSM_LND_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mSM_LND_namespace::model_mSM_LND stan_model;
#ifndef USING_R
