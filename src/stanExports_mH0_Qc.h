...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mH0_Qc");
    reader.add_event(45, 43, "end", "model_mH0_Qc");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mH0_Qc
  : public stan::model::model_base_crtp<model_mH0_Qc> {
private:
        int N;
        std::vector<int> Y;
...
typedef model_mH0_Qc_namespace::model_mH0_Qc stan_model;
#ifndef USING_R
