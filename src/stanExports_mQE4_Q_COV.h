...
public:
  ...
  inline std::string model_name() const final { return "model_mQE4_Q_COV"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mQE4_Q_COV(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mQE4_Q_COV_namespace::model_mQE4_Q_COV";
    ...
    try {
      ...
      priormuQ = Eigen::Matrix<double, -1, -1>(4, nlevels);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mQE4_Q_COV_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
                ...
                (-stan::math::log((1 - q)) /
                  (stan::math::exp(k[(mn - 1)]) +
                    ((stan::math::exp(k[(mn - 1)]) *
                      ...
                      stan::math::exp(d[(mn - 1)])))), "assigning variable b");
            }
          } else {
                               ...
                               0);}
      {
        ...
        for (int i = 1; i <= nlevels_d; ++i) {
          ...
          if (logical_gt(par3[(i - 1)], truncdQ)) {
            current_statement__ = 45;
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mQE4_Q_COV_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
