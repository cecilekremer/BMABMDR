...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mQE4_Q_COV");
    reader.add_event(157, 155, "end", "model_mQE4_Q_COV");
    return reader;
}
...
class model_mQE4_Q_COV
  : public stan::model::model_base_crtp<model_mQE4_Q_COV> {
private:
        int N;
        int nlevels;
        int nlevels_a;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "priormuQ", "matrix_d", context__.to_vec(4,nlevels));
            priormuQ = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(4, nlevels);
        ...
        try {
            ...
            if (as_bool((primitive_value((primitive_value(logical_eq(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::model::assign(b, 
                                stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                (-(stan::math::log((1 - q))) / (stan::math::exp(get_base1(k, 1, "k", 1)) + ((stan::math::exp(get_base1(k, 1, "k", 1)) * (stan::math::exp(get_base1(k, 1, "k", 1)) - 1)) / stan::math::exp(get_base1(d, 1, "d", 1))))), 
                ...
                for (int mn = 1; mn <= nlevels_b; ++mn) {
                    ...
                    stan::model::assign(b, 
                                stan::model::cons_list(stan::model::index_uni(mn), stan::model::nil_index_list()), 
                                (-(stan::math::log((1 - q))) / (stan::math::exp(get_base1(k, mn, "k", 1)) + ((stan::math::exp(get_base1(k, mn, "k", 1)) * (stan::math::exp(get_base1(k, mn, "k", 1)) - 1)) / stan::math::exp(get_base1(d, mn, "d", 1))))), 
                                "assigning variable b");
                }
            ...
            for (int i = 1; i <= nlevels_a; ++i) {
                ...
                lp_accum__.add(pert_dist_lpdf<propto__>(get_base1(par1, i, "par1", 1), get_base1(priorlb, 1, i, "priorlb", 1), get_base1(priormuQ, 1, i, "priormuQ", 1), get_base1(priorub, 1, i, "priorub", 1), get_base1(priorgama, 1, i, "priorgama", 1), pstream__));
            }
            current_statement_begin__ = 93;
            for (int i = 1; i <= nlevels_BMD; ++i) {
                current_statement_begin__ = 94;
                lp_accum__.add(pert_dist_lpdf<propto__>(get_base1(par2, i, "par2", 1), get_base1(priorlb, 2, i, "priorlb", 1), get_base1(priormuQ, 2, i, "priormuQ", 1), get_base1(priorub, 2, i, "priorub", 1), get_base1(priorgama, 2, i, "priorgama", 1), pstream__));
            }
            current_statement_begin__ = 98;
            for (int i = 1; i <= nlevels_d; ++i) {
                current_statement_begin__ = 99;
                lp_accum__.add(normal_log<propto__>(get_base1(par3, i, "par3", 1), get_base1(priormuQ, 3, i, "priormuQ", 1), get_base1(priorSigmaQ, 3, 3, "priorSigmaQ", 1)));
                if (get_base1(par3, i, "par3", 1) > truncdQ) lp_accum__.add(-std::numeric_limits<double>::infinity());
                else lp_accum__.add(-normal_cdf_log(truncdQ, get_base1(priormuQ, 3, i, "priormuQ", 1), get_base1(priorSigmaQ, 3, 3, "priorSigmaQ", 1)));
            }
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_eq(nlevels_d, 1)))) && primitive_value(logical_eq(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            } else if (as_bool((primitive_value((primitive_value(logical_gt(nlevels_a, 1)) && primitive_value(logical_gt(nlevels_d, 1)))) && primitive_value(logical_gt(nlevels_BMD, 1))))) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, mn, "a", 1) + ((1 - get_base1(a, mn, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, mn, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, mn, "b", 1) / stan::math::exp(get_base1(d, mn, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    for (int mn = 1; mn <= nlevels; ++mn) {
                        ...
                        if (as_bool(logical_eq(get_base1(x, i, "x", 1), 0))) {
                            ...
                            lp_accum__.add((((binomial_coefficient_log(get_base1(n, i, "n", 1), get_base1(y, i, "y", 1)) + (get_base1(y, i, "y", 1) * stan::math::log(((get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1))))))) + eps)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log(((1 - (get_base1(a, 1, "a", 1) + ((1 - get_base1(a, 1, "a", 1)) * (1 - stan::math::exp(((-(get_base1(b, 1, "b", 1)) * get_base1(x, i, "x", 1)) - (((get_base1(b, 1, "b", 1) / stan::math::exp(get_base1(d, 1, "d", 1))) * get_base1(x, i, "x", 1)) * (get_base1(x, i, "x", 1) - 1)))))))) + eps)))) * get_base1(trt_ind, i, mn, "trt_ind", 1)));
                        }
                    }
                }
            }
...
typedef model_mQE4_Q_COV_namespace::model_mQE4_Q_COV stan_model;
#ifndef USING_R
