...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 56, column 2 to column 82)",
                                                      " (in 'string', line 62, column 6 to column 86)",
                                                      ...
                                                      " (in 'string', line 59, column 15 to line 61, column 5)",
                                                      " (in 'string', line 59, column 2 to line 63, column 5)",
                                                      ...
                                                      " (in 'string', line 79, column 4 to column 71)",
                                                      " (in 'string', line 80, column 4 to column 71)",
                                                      " (in 'string', line 81, column 49 to column 55)",
                                                      " (in 'string', line 81, column 4 to column 57)",
                                                      " (in 'string', line 91, column 6 to column 61)",
                                                      " (in 'string', line 93, column 8 to line 95, column 46)",
                                                      " (in 'string', line 92, column 19 to line 96, column 7)",
                                                      " (in 'string', line 92, column 6 to line 96, column 7)",
                                                      " (in 'string', line 89, column 11 to line 97, column 5)",
                                                      " (in 'string', line 86, column 8 to column 93)",
                                                      " (in 'string', line 85, column 19 to line 87, column 7)",
                                                      " (in 'string', line 85, column 6 to line 87, column 7)",
                                                      " (in 'string', line 83, column 17 to line 89, column 5)",
                                                      " (in 'string', line 83, column 3 to line 97, column 5)",
...
public:
  ...
  inline std::string model_name() const final { return "model_mL4_Q"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mL4_Q(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mL4_Q_namespace::model_mL4_Q";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mL4_Q_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      b = (stan::math::exp((-k * d)) *
            (((pow(3, 0.5) / stan::math::pi()) * logit(((q * (1 - a)) + a)))
              - ((pow(3, 0.5) / stan::math::pi()) * logit(a))));
            ...
            assign(m, cons_list(index_uni(i), nil_index_list()),
              inv_logit(
                ((stan::math::pi() / pow(3, 0.5)) *
                  (((pow(3, 0.5) / stan::math::pi()) * logit(a)) +
                    (b * pow(x[(i - 1)], d))))), "assigning variable m");
          } 
        }}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mL4_Q_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
