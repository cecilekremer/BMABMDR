...
transformed parameters {
  ...
  if (nlevels_a == 1 && nlevels_d == 1 && nlevels_BMD == 1) {
    for (mn in 1 : nlevels_b) {
      if (data_type == 1) {
        b[1] = exp(k[1] * d[1]) * (((c[1] - 1) / q) - 1);
      } else if (data_type == 2) {
        b[1] = exp(k[1] * d[1]) * (((a[1] * (c[1] - 1)) / log(1 + q)) - 1);
      } else if (data_type == 3) {
        b[1] = exp(k[1] * d[1]) * (((c[1] - 1) / (-q)) - 1);
      } else if (data_type == 4) {
        b[1] = exp(k[1] * d[1]) * (((a[1] * (c[1] - 1)) / log(1 - q)) - 1);
    ...
    for (mn in 1 : nlevels_b) {
      if (data_type == 1) {
        b[mn] = exp(k[1] * d[1]) * (((c[mn] - 1) / q) - 1);
      } else if (data_type == 2) {
        b[mn] = exp(k[1] * d[1]) * (((a[mn] * (c[mn] - 1)) / log(1 + q)) - 1);
      } else if (data_type == 3) {
        b[mn] = exp(k[1] * d[1]) * (((c[mn] - 1) / (-q)) - 1);
      } else if (data_type == 4) {
        b[mn] = exp(k[1] * d[1]) * (((a[mn] * (c[mn] - 1)) / log(1 - q)) - 1);
    ...
    for (mn in 1 : nlevels_b) {
      if (data_type == 1) {
        b[mn] = exp(k[mn] * d[mn]) * (((c[1] - 1) / q) - 1);
      } else if (data_type == 2) {
        b[mn] = exp(k[mn] * d[mn]) * (((a[1] * (c[1] - 1)) / log(1 + q)) - 1);
      } else if (data_type == 3) {
        b[mn] = exp(k[mn] * d[mn]) * (((c[1] - 1) / (-q)) - 1);
      } else if (data_type == 4) {
        b[mn] = exp(k[mn] * d[mn]) * (((a[1] * (c[1] - 1)) / log(1 - q)) - 1);
    ...
    for (mn in 1 : nlevels_b) {
      if (data_type == 1) {
        b[mn] = exp(k[mn] * d[mn]) * (((c[mn] - 1) / q) - 1);
      } else if (data_type == 2) {
        b[mn] = exp(k[mn] * d[mn])
                * (((a[mn] * (c[mn] - 1)) / log(1 + q)) - 1);
      } else if (data_type == 3) {
        b[mn] = exp(k[mn] * d[mn]) * (((c[mn] - 1) / (-q)) - 1);
      } else if (data_type == 4) {
        b[mn] = exp(k[mn] * d[mn])
